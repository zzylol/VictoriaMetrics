...
Every LTS line receives bugfixes and [security fixes](https://github.com/zzylol/VictoriaMetrics/blob/master/SECURITY.md) for 12 months after
...
All the bugfixes and security fixes, which are included in LTS releases, are also available in [the latest release](https://github.com/zzylol/VictoriaMetrics/releases/latest),
...
- v1.102.x - the latest one is [v1.102.4 LTS release](https://github.com/zzylol/VictoriaMetrics/releases/tag/v1.102.2)
- v1.97.x - the latest one is [v1.97.9 LTS release](https://github.com/zzylol/VictoriaMetrics/releases/tag/v1.97.7)
