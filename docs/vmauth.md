...
and [load balance](https://docs.victoriametrics.com/vmauth/#load-balancing) requests across [VictoriaMetrics](https://github.com/zzylol/VictoriaMetrics) components
or any other HTTP backends.

## Quick start

Just download `vmutils-*` archive from [releases page](https://github.com/zzylol/VictoriaMetrics/releases/latest), unpack it
...
See how `vmauth` used in [docker-compose env](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/README.md#victoriametrics-cluster).
...
See config example of using IP filters [here](https://github.com/zzylol/VictoriaMetrics/blob/master/app/vmauth/example_config_ent.yml).
...
# even if such a route also exists in the users section (see https://github.com/zzylol/VictoriaMetrics/issues/5236).
unauthorized_user:
  url_prefix:
...
Use the official [Grafana dashboard](https://grafana.com/grafana/dashboards/21394) and [alerting rules](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/rules/alerts-vmauth.yml)
...
It is recommended using [binary releases](https://github.com/zzylol/VictoriaMetrics/releases/latest) - `vmauth` is located in `vmutils-*` archives there.

### Development build

1. [Install Go](https://golang.org/doc/install). The minimum supported version is Go 1.22.
1. Run `make vmauth` from the root folder of [the repository](https://github.com/zzylol/VictoriaMetrics).
   It builds `vmauth` binary and puts it into the `bin` folder.

### Production build

1. [Install docker](https://docs.docker.com/install/).
1. Run `make vmauth-prod` from the root folder of [the repository](https://github.com/zzylol/VictoriaMetrics).
