...
* Integration with [VictoriaMetrics](https://github.com/zzylol/VictoriaMetrics) and [MetricsQL](https://docs.victoriametrics.com/metricsql/);
...
* Detect alerting rules which [don't match any series](https://github.com/zzylol/VictoriaMetrics/issues/4039).
...
```sh
git clone https://github.com/zzylol/VictoriaMetrics
cd VictoriaMetrics
make vmalert
```
...
* notifier address [optional] - reachable [Alert Manager](https://github.com/prometheus/alertmanager) instance for processing,
  ...
  [config file](https://github.com/zzylol/VictoriaMetrics/blob/master/app/vmalert/notifier/config.go).
...
in [testdata](https://github.com/zzylol/VictoriaMetrics/blob/master/app/vmalert/config/testdata) folder.
...
# start at 5th minute of the hour. See https://github.com/zzylol/VictoriaMetrics/issues/3409
...
# See https://github.com/zzylol/VictoriaMetrics/issues/5155 and https://docs.victoriametrics.com/keyconcepts/#query-latency.
[ eval_delay: <duration> ]
...
field. See [how we use them](https://github.com/zzylol/VictoriaMetrics/blob/839596c00df123c639d1244b28ee8137dfc9609c/deployment/docker/rules/alerts-cluster.yml#L43)
...
at [release page](https://github.com/zzylol/VictoriaMetrics/releases/latest) and in `*-enterprise`
...
The default list of alerting rules for these metric can be found [here](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker).
...
See more details [here](https://github.com/zzylol/VictoriaMetrics/issues/4039).
...
The configuration file [specification](https://github.com/zzylol/VictoriaMetrics/blob/master/app/vmalert/notifier/config.go)
is the following:
...
Run the following commands from the root folder of [the repository](https://github.com/zzylol/VictoriaMetrics):
```sh
...
1. Run `make vmalert` from the root folder of [the repository](https://github.com/zzylol/VictoriaMetrics).
   It builds `vmalert` binary and puts it into the `bin` folder.

### Production build

1. [Install docker](https://docs.docker.com/install/).
1. Run `make vmalert-prod` from the root folder of [the repository](https://github.com/zzylol/VictoriaMetrics).
...
1. [Install Go](https://golang.org/doc/install). The minimum supported version is Go 1.22.
1. Run `make vmalert-linux-arm` or `make vmalert-linux-arm64` from the root folder of [the repository](https://github.com/zzylol/VictoriaMetrics).
   It builds `vmalert-linux-arm` or `vmalert-linux-arm64` binary respectively and puts it into the `bin` folder.

### Production ARM build

1. [Install docker](https://docs.docker.com/install/).
1. Run `make vmalert-linux-arm-prod` or `make vmalert-linux-arm64-prod` from the root folder of [the repository](https://github.com/zzylol/VictoriaMetrics).
