...
The `VMAlert` CRD declaratively defines a desired [VMAlert](https://github.com/zzylol/VictoriaMetrics/tree/master/app/vmalert)
...
To set `VMAlert` version add `spec.image.tag` name from [releases](https://github.com/zzylol/VictoriaMetrics/releases)
