...
It is recommended to use the [single-node version](https://github.com/zzylol/VictoriaMetrics) instead of the cluster version
...
- Supports all the features of the [single-node version](https://github.com/zzylol/VictoriaMetrics).
...
Compiled binaries for the cluster version are available in the `assets` section of the [releases page](https://github.com/zzylol/VictoriaMetrics/releases/latest).
...
The source code for the cluster version is available in the [cluster branch](https://github.com/zzylol/VictoriaMetrics/tree/cluster).
...
1. Run `make` from [the repository root](https://github.com/zzylol/VictoriaMetrics). It should build `vmstorage`, `vmselect`
...
`<PKG_TAG>` is auto-generated image tag, which depends on source code in [the repository](https://github.com/zzylol/VictoriaMetrics).
...
- [An example docker-compose config for VictoriaMetrics cluster](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/docker-compose-cluster.yml)
...
[Enterprise version of VictoriaMetrics](https://docs.victoriametrics.com/enterprise/) can be downloaded and evaluated for free from [the releases page](https://github.com/zzylol/VictoriaMetrics/releases/latest).
See how to request a free trial license [here](https://victoriametrics.com/products/enterprise/trial/).
...
It is recommended setting up alerts in [vmalert](https://docs.victoriametrics.com/vmalert/) or in Prometheus from [this list](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker#alerts).
