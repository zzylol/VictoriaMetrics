---
weight: 38
editLink: https://github.com/zzylol/VictoriaMetrics-datasource/blob/main/README.md
...
The [VictoriaMetrics datasource plugin](https://github.com/zzylol/VictoriaMetrics-datasource) 
...
[VictoriaMetrics repo](https://github.com/zzylol/VictoriaMetrics) provides a complete [docker-compose](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker#docker-compose-environment-for-victoriametrics) environment to spin-up all required components via Docker.

To begin, clone [VictoriaMetrics](https://github.com/zzylol/VictoriaMetrics) repository and follow steps described in the [README](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker#docker-compose-environment-for-victoriametrics).
   ...
   ```yaml
     ...
     services:
       grafana:
         ...
         environment:
         - GF_INSTALL_PLUGINS=https://github.com/zzylol/VictoriaMetrics-datasource/releases/download/v0.10.1/victoriametrics-datasource-v0.10.1.zip;victoriametrics-datasource
...
``` yaml
plugins:
  - https://github.com/zzylol/VictoriaMetrics-datasource/releases/download/v0.10.1/victoriametrics-datasource-v0.10.1.zip;victoriametrics-datasource
```
  ...
  - name: "load-vm-ds-plugin"
    ...
    args:
     ...
     - |
       ...
       curl -L https://github.com/zzylol/VictoriaMetrics-datasource/releases/download/$ver/victoriametrics-datasource-$ver.tar.gz -o /var/lib/grafana/plugins/vm-plugin.tar.gz
...
1. Go to <https://github.com/zzylol/VictoriaMetrics-datasource/releases> and verify that draft release with the name `TAG` has been created and this release contains all the needed binaries and checksums.
...
Grafana doesn't allow forwarding Alert requests to alerting API /api/v1/rules for plugins which are not of Prometheus or Loki type. See more details [here](https://github.com/zzylol/VictoriaMetrics-datasource/issues/59#issuecomment-1541456768).

## License

This project is licensed under
the [AGPL-3.0-only](https://github.com/zzylol/VictoriaMetrics-datasource/blob/main/LICENSE).
