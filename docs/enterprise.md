...
VictoriaMetrics community components are open source and are free to use - see [the source code](https://github.com/zzylol/VictoriaMetrics/)
and [the license](https://github.com/zzylol/VictoriaMetrics/blob/master/LICENSE).

VictoriaMetrics Enterprise components are available in binary form at [releases page](https://github.com/zzylol/VictoriaMetrics/releases/latest)
...
Binary releases of VictoriaMetrics Enterprise are available [at the releases page](https://github.com/zzylol/VictoriaMetrics/releases/latest).
...
from the [releases page](https://github.com/zzylol/VictoriaMetrics/releases/latest) and unpack it. Then run the unpacked binary.
...
```sh
wget https://github.com/zzylol/VictoriaMetrics/releases/download/v1.105.0/victoria-metrics-linux-amd64-v1.105.0-enterprise.tar.gz
