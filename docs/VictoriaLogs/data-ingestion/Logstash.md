...
- [Docker-compose demo for Logstash integration with VictoriaLogs](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/logstash).
