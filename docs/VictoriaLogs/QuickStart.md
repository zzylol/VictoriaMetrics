...
Pre-built binaries for VictoriaLogs are available at the [releases](https://github.com/zzylol/VictoriaMetrics/releases/) page.
...
```sh
curl -L -O https://github.com/zzylol/VictoriaMetrics/releases/download/v0.40.0-victorialogs/victoria-logs-linux-amd64-v0.40.0-victorialogs.tar.gz
...
- [Filebeat demo](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/filebeat)
- [Fluentbit demo](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/fluentbit)
- [Logstash demo](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/logstash)
- [Vector demo](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/vector)
- [Promtail demo](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/promtail)
