...
1. Try searching for the issue at [VictoriaMetrics GitHub](https://github.com/zzylol/VictoriaMetrics/issues).
...
1. Try searching for information about the issue in [VictoriaMetrics source code](https://github.com/search?q=repo%3AVictoriaMetrics%2FVictoriaMetrics&type=code).
   GitHub code search may be not very good in some cases, so it is recommended [checking out VictoriaMetrics source code](https://github.com/zzylol/VictoriaMetrics/)
   and perform local search in the checked out code.
   Note that the source code for VictoriaMetrics cluster is located in [the cluster](https://github.com/zzylol/VictoriaMetrics/tree/cluster) branch.
...
1. If steps above didn't help finding the solution to the issue, then please [file a new issue](https://github.com/zzylol/VictoriaMetrics/issues/new/choose)
...
1. Pro tip 1: if you see that [VictoriaMetrics docs](https://docs.victoriametrics.com/) contain incomplete or incorrect information,
   ...
   All the docs published at `https://docs.victoriametrics.com` are located in the [docs](https://github.com/zzylol/VictoriaMetrics/tree/master/docs)
...
1. Try upgrading to the [latest available version of VictoriaMetrics](https://github.com/zzylol/VictoriaMetrics/releases/latest)
...
1. If the steps above didn't help identifying the root cause of unexpected query results,
   then [file a bugreport](https://github.com/zzylol/VictoriaMetrics/issues/new) with details on how to reproduce the issue.
...
1. If you see `TooHighSlowInsertsRate` [alert](https://docs.victoriametrics.com/#monitoring) when single-node VictoriaMetrics or `vmstorage` has enough
   ...
   See [this comment](https://github.com/zzylol/VictoriaMetrics/issues/3976#issuecomment-1476883183) for more details.
...
The list of [recommended alerting rules](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker#alerts)
