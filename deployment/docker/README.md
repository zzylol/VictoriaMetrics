...
**All commands should be executed from the root directory of [the repo](https://github.com/zzylol/VictoriaMetrics).**
...
It accepts Prometheus-compatible configuration [prometheus.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/prometheus.yml)
...
vmauth config is available [here](ttps://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/auth-cluster.yml)


## vmalert

vmalert evaluates alerting rules [alerts.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/rules/alerts.yml)
...
All notifications are blackholed according to [alertmanager.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/alertmanager.yml) config.
...
Optionally, environment with [VictoriaMetrics Grafana datasource](https://github.com/zzylol/VictoriaMetrics-datasource)
...
* [alerts-health.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/rules/alerts-health.yml):
  alerting rules related to all VictoriaMetrics components for tracking their "health" state; 
* [alerts.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/rules/alerts.yml):
...
* [alerts-cluster.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/rules/alerts-cluster.yml):
  alerting rules related to [cluster version of VictoriaMetrics](https://docs.victoriametrics.com/cluster-victoriametrics/);
* [alerts-vmagent.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/rules/alerts-vmagent.yml):
  alerting rules related to [vmagent](https://docs.victoriametrics.com/vmagent/) component;
* [alerts-vmalert.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/rules/alerts-vmalert.yml):
  alerting rules related to [vmalert](https://docs.victoriametrics.com/vmalert/) component;
* [alerts-vmauth.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/rules/alerts-vmauth.yml):
  alerting rules related to [vmauth](https://docs.victoriametrics.com/vmauth/) component;
* [alerts-vlogs.yml](https://github.com/zzylol/VictoriaMetrics/blob/master/deployment/docker/rules/alerts-vlogs.yml):
...
* [filebeat-docker](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/filebeat-docker) 
* [filebeat-syslog](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/filebeat-syslog) 
* [fluentbit-docker](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/fluentbit-docker) 
* [logstash](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/logstash) 
* [promtail](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/promtail) 
* [vector-docker](https://github.com/zzylol/VictoriaMetrics/tree/master/deployment/docker/victorialogs/vector-docker)
