...
func stop(addr string) error {
	...
	if *shutdownDelay > 0 {
		...
		// See https://github.com/zzylol/VictoriaMetrics/issues/463 .
...
func handlerWrapper(s *server, w http.ResponseWriter, r *http.Request, rh RequestHandler) {
	...
	case "/-/healthy":
		...
		// See https://github.com/zzylol/VictoriaMetrics/issues/1833
	...
	case "/robots.txt":
		...
		// See https://github.com/zzylol/VictoriaMetrics/issues/4128
...
func isProtectedByAuthFlag(path string) bool {
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/6329
...
func Redirect(w http.ResponseWriter, url string) {
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/2918
