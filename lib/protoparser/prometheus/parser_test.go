...
func TestRowsUnmarshalFailure(t *testing.T) {
	...
	// invalid tags - see https://github.com/zzylol/VictoriaMetrics/issues/4284
...
cassandra_token_ownership_ratio 78.9`, &Rows{
	...
	// Checks for https://github.com/zzylol/VictoriaMetrics/issues/924
	inf := math.Inf(1)
	f(`
		foo Infinity
		bar +Infinity
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/350
	f(`foo{bar="baz",} 1 2`, &Rows{
		Rows: []Row{{
			Metric: "foo",
			Tags: []Tag{{
