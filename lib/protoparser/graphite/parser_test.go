...
func TestRowsUnmarshal_Success(t *testing.T) {
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/3102
	...
	// Empty tags
	// See https://github.com/zzylol/VictoriaMetrics/issues/1100
	f("foo; 1", &Rows{
		Rows: []Row{{
			Metric: "foo",
			Tags:   []Tag{},
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/1865
	f("foo.baz 125 1789 \na 1.34 567\t  ", &Rows{
		Rows: []Row{
			{
				Metric:    "foo.baz",
