...
import (
	...
	"github.com/zzylol/VictoriaMetrics/lib/bloomfilter"
	...
	"github.com/zzylol/VictoriaMetrics/lib/snapshot/snapshotutil"
...
type Storage struct {
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/1401
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/430 for details.
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/5959
...
func MustOpenStorage(path string, retention time.Duration, maxHourlySeries, maxDailySeries int) *Storage {
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/1447 for details.
	...
	// to prevent unexpected part merges. See https://github.com/zzylol/VictoriaMetrics/issues/4023
...
func (s *Storage) mustRotateIndexDB(currentTime time.Time) {
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/2698
...
func (s *Storage) resetAndSaveTSIDCache() {
	...
	// See https://github.com/zzylol/VictoriaMetrics/issues/1347
	s.tsidCache.Reset()
...
// See https://github.com/zzylol/VictoriaMetrics/pull/2574
...
func nextRetentionDeadlineSeconds(atSecs, retentionSecs, offsetSecs int64) int64 {
	...
	// because of historical reasons - see https://github.com/zzylol/VictoriaMetrics/issues/248
	offsetSecs -= 4 * 3600
	...
	for i := range rows {
		...
		if hour == hm.hour {
			...
			if hm.m.Has(metricID) {
				...
				// This should address https://github.com/zzylol/VictoriaMetrics/issues/430 .
				if pMin > 0 {
...
func (s *Storage) updateNextDayMetricIDs(date uint64) {
	...
	if e.k.generation == generation && e.k.date == date {
		...
		// See https://github.com/zzylol/VictoriaMetrics/issues/3309
...
//     This should resolve https://github.com/zzylol/VictoriaMetrics/issues/5959
