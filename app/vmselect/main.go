...
import (
	...
	"github.com/zzylol/VictoriaMetrics/app/vmselect/graphite"
...
func handleStaticAndSimpleRequests(w http.ResponseWriter, r *http.Request, path string) bool {
	...
	case "/api/v1/status/buildinfo":
		...
		// see this issue for more info: https://github.com/zzylol/VictoriaMetrics/issues/5370
...
func proxyVMAlertRequests(w http.ResponseWriter, r *http.Request) {
	defer func() {
		...
		if err == nil || err == http.ErrAbortHandler {
			...
			// See https://github.com/zzylol/VictoriaMetrics/issues/1353
			return
		}
