...
- /MetricsQL.html
---
[VictoriaMetrics](https://github.com/zzylol/VictoriaMetrics) implements MetricsQL -
...
* MetricsQL doesn't extrapolate [rate](#rate) and [increase](#increase) function results, so it always returns the expected results. For example, it returns
  ...
  and [increase](#increase) [in this issue](https://github.com/zzylol/VictoriaMetrics/issues/1215#issuecomment-850305711).
...
* MetricsQL keeps metric names after applying functions, which don't change the meaning of the original time series.
  ...
  See [this issue](https://github.com/zzylol/VictoriaMetrics/issues/674) for details.
...
[File an issue](https://github.com/zzylol/VictoriaMetrics/issues) if you notice discrepancies between PromQL and MetricsQL results other than mentioned above.
...
Feel free [filing a feature request](https://github.com/zzylol/VictoriaMetrics/issues) if you think MetricsQL misses certain useful functionality.
...
Otherwise, the returned result may be invalid. See [this issue](https://github.com/zzylol/VictoriaMetrics/issues/3231) for details.
